...
The current package metadata targets Unity 6000.7 or newer and declares `com.bovinelabs.core` 2.0.0-pre.1, Unity App UI 3.0.0-pre.1, and Universal Render Pipeline 17.7.0 as dependencies.
