...
Anchor 2.0.0-pre.2 declares Unity 6000.7, `com.bovinelabs.core` 2.0.0-pre.1, Unity App UI 3.0.0-pre.1, and Universal Render Pipeline 17.7.0 in `package.json`.
